...
export declare class TTScrollableView implements AfterViewInit, OnDestroy, AfterViewChecked {
    ...
    tableHeaderBodyViewChild: ElementRef;
    virtualScrollBodyViewChild: ElementRef;
    viewPortViewChild: CdkVirtualScrollViewport;
    ...
    constructor(tt: TreeTable, el: ElementRef, zone: NgZone, scrollDispatcher: ScrollDispatcher);
    scrollHeight: string;
...
export declare class CdkVirtualScrollViewportPatchDirective implements OnInit, OnDestroy {
    private readonly viewportComponent;
    protected readonly destroy$: Subject<{}>;
    constructor(viewportComponent: CdkVirtualScrollViewport);
    ngOnInit(): void;
    ngOnDestroy(): void;
}
